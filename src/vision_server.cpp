                          ...
                          vision::robot2vision::Response &res)
{
   ...
   if(req.command == 1)
   {
      ...
      res.num = object;
      ROS_INFO("object = %ld", (long int)res.num);
      ...
      if (object != 0)
      {
         ...
         ROS_INFO("object position : x = %f, y = %f, theta = %f", res.robot_x, res.robot_y, res.robot_theta);
...
public:
  ...
  void imageCb(const sensor_msgs::ImageConstPtr& msg)
  {
    ...
    service = nh_.advertiseService("robot_vision", robot_connect_vision);
